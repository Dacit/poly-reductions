...
HOL_To_IMP_correct Pos_nat by cook

compile_nat Neg_nat_def
HOL_To_IMP_correct Neg_nat by cook

compile_nat HTHN.is_n_clause_list_nat_eq_unfolded
HOL_To_IMP_correct HOL_To_HOL_Nat.is_n_clause_list_nat by cook
...
HOL_To_IMP_correct HOL_To_HOL_Nat.is_n_sat_list_nat
...
HOL_To_IMP_correct HOL_To_HOL_Nat.flip_lit_nat by cook
